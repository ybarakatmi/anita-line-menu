...
function normalizeSiteSettingsRow(row: SiteSettingsRow): SiteSettingsRow {
  ...
  return {
    ...
    hero_subtitle: asNullableText(row.hero_subtitle),
    hero_tag1: asNullableText(row.hero_tag1),
    hero_tag2: asNullableText(row.hero_tag2),
    hero_tag3: asNullableText(row.hero_tag3),
    hero_primary_label: asNullableText(row.hero_primary_label),
